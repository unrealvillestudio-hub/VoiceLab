...
import { VoiceLabProvider } from './context/VoiceLabContext';
import { useSessionOutputsStore } from './store/useSessionOutputsStore';
import { Clock, History, Trash2, Mic2 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-50 font-sans selection:bg-emerald-500/30 flex flex-col">
      ...
      <div className="flex-1 flex overflow-hidden">
        {/*
          VoiceLabProvider wraps the full content area so both the main module
          and the sidebar history panel share the same loaded data without refetch.
        */}
        <VoiceLabProvider>
          {/* Main Content */}
          ...
          {/* Sidebar History */}
          <aside className="w-80 border-l border-white/10 bg-zinc-900/30 flex-col hidden xl:flex">
